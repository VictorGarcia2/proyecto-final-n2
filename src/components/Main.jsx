...
export default function Main({ data }) {
  ...
  return (
    <div className="bg-[#100E1D] w-full flex flex-col items-center h-full md:h-screen ">
          ...
          <div className="w-full grid place-content-center  ">
            ...
            <div className=" grid   grid-cols-1 gap-3 md:grid-cols-2  ">
              <div className="bg-[#1E213A]  grid place-content-center gap-10 w-72 h-48 md:w-80 text-center text-white font-display">
                <p>Wind status</p>
                <p className="text-5xl font-bold">0.89ms</p>
              ...
              <div className="bg-[#1E213A] grid place-content-center gap-10 h-48 md:w-80 text-center text-white font-display">
                <p>Humidity</p>
                <p className="text-5xl font-bold">{`${humedad}%`}</p>
                <div className="flex flex-col items-center  justify-center">
                  ...
                  <div className="bg-amber-300 w-[200px] mt-1  rounded-4xl h-2">
                    <div className="bg-white h-2 rounded-4xl" style={{ width: `${humedad}%` }}></div>
                  </div>
                </div>
              </div>
              <div className="bg-[#1E213A] grid place-content-center gap-5 h-36 md:w-80  text-center text-white font-display">
                <p>Visibility</p>
                <p className="text-5xl font-bold">3.22km</p>
              </div>
              <div className="bg-[#1E213A] grid place-content-center gap-5 h-36 md:w-80  text-center text-white font-display">
                <p>Air Pressure</p>
                <p className="text-5xl font-bold">1017mb</p>
              </div>
            </div>
          </div>
        </div>
